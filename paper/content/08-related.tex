...
Simba and Occamy are the machines: scale-out inference and
high-performance computing across
chiplets~\cite{shao2019simba,scheffler2025occamy}.
{SNAX} hangs accelerators on a {RISC-V}
cluster~\cite{antonio2025snax}.
This paper is the path from that kind of machine back into a compiler
a {PyTorch} user can run.

FireSim uses {FPGA}s as cycle-exact {ASIC}
